...
classes = [
    ...
    operators.MESH_OT_update_spider_web_position,
    operators.MESH_OT_update_spider_web_selected,
    operators.MESH_OT_set_target_from_cursor,
    operators.MESH_OT_set_origin_from_cursor,
